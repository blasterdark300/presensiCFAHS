							...
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">
										<center>
											<img src="../assets/img/logocf1.png" width="100">
											<br>
											<b>CF Academy High School</b>
										</center>
									</div>
									<div class="card-category">
										<center>
Jalan Menganti Laban Grogol rt25 rw2, Grogol, Setro, Kec. Menganti, Kabupaten Gresik, Jawa Timur 61152
	<br>Email : CFAHS@gmail.com Telp.081334419884
										</center>
									</div>
								...
								<div class="card-body">
									...
									<div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
										...
										<div class="tab-pane fade" id="pills-contact-icon" role="tabpanel" aria-labelledby="pills-contact-tab-icon">
											<p>
												<hr>
												Aplikasi Absensi siswa ini dibuat untuk mendokumentasikan kehadiran siswa, Aplikasi sangat Mudah digunakan (Berbasis Mobile)
											</p>
										</div>
									</div>
								</div>
