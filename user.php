                        ...
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    ...
                                    <h5 class="text-white op-7 mb-2">Aplikasi Absensi Berbasis Mobile</h5>
                                </div>
    ...
    <footer class="footer">
        <div class="container">
            <div class="copyright ml-auto">
                &copy; <?php echo date('Y');?> Absensi Siswa CF Academy High School (<a href="index.php">Crismono Sadi </a>
                | 2021)
            </div>
        </div>
    </footer>
